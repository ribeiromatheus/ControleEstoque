...
namespace ControleEstoque.Web.Controllers
{
    public class ContaController : BaseController
    {
        ...
        public ActionResult Login(LoginViewModel login, string returnUrl)
        {
            ...
            if (usuario != null)
            {
                ...
                var ticket = FormsAuthentication.Encrypt(new FormsAuthenticationTicket(
                    1, usuario.Nome, DateTime.Now, DateTime.Now.AddHours(12), login.LembrarMe, 
                    usuario.Id + "|" + usuario.RecuperarStringNomePerfis()));
        ...
        private void EnviarEmailRedefinicaoSenha(UsuarioModel usuario)
        {
            ...
            mensagem.Body = string.Format("Redefina sua senha <a href='{0}'>aqui</a>", callbackUrl);
